package io.flexdata.spring.orm.aspect;
...
public class DataSourceAspect {
     ...
     */
    @Pointcut("@annotation(io.flexdata.spring.orm.annotation.DataSource)")
    public void dataSourcePointcut() {}
    
    /**
     * 切点：类级别的@DataSource注解
     */
    @Pointcut("@within(io.flexdata.spring.orm.annotation.DataSource)")
