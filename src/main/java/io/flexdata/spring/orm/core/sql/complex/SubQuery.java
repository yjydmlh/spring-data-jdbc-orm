...
public class SubQuery {
    private final ComplexSelectQuery selectQuery;
    private final Map<String, Object> parameters;
    
    public SubQuery(ComplexSelectQuery selectQuery) {
        this.selectQuery = selectQuery;
        this.parameters = new HashMap<>();
    }
    
    public ComplexSelectQuery getSelectQuery() { return selectQuery; }
    public Map<String, Object> getParameters() { return parameters; }
    
    public String toSql() {
        return "(" + generateQuerySql(selectQuery) + ")";
    }
    ...
    public Map<String, Object> getAllParameters() {
        return selectQuery.getAllParameters();
    }
}